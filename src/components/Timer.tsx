	...
	render() {
		const body = (
			<div>
				...
				<div className='flex'>
					<button
						className='flex-auto bg-green-400 hover:bg-green-500 p-3 m-1 rounded-lg text-white text-center'
					...
					{!this.state.running && (
						<button
							className='flex-auto bg-blue-400 hover:bg-blue-500 p-3 m-1 rounded-lg text-white text-center'
							onClick={this.reset}
						>
							Reset
						</button>
